...
class utilizouHoraExtra(View):
    def post(self, *args, **kwargs):
        ...
        registro_hora_extra.ultilizada = True
...
class naoutilizouHoraExtra(View):
    def post(self, *args, **kwargs):
        ...
        registro_hora_extra = RegistroHoraExtra.objects.get(id=kwargs['pk'])
        registro_hora_extra.ultilizada = False
        registro_hora_extra.save()
...
class ExportarParaCSV(View):
    def get(self, request):
        ...
        registro_he = RegistroHoraExtra.objects.filter(ultilizada=False)
...
class ExportarParaExcel(View):
    def get(self, request):
        ...
        columns = ['Id', 'Motivo', 'Funcionario', 'Rest. Fun', 'Horas']
        ...
        registros = RegistroHoraExtra.objects.filter(ultilizada=False)
